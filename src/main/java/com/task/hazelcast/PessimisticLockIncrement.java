...
public class PessimisticLockIncrement {

    static final String MAP_NAME = "counter-pessimistic";
    static final String KEY = "key";
    static final int ITERATIONS = 10_000;
    static final int CLIENTS = 3;

    public static void main(String[] args) throws InterruptedException {
        System.out.println("=== Task 5: Pessimistic Lock Increment (3 clients x 10K = expected 30K) ===");
        ...
        System.out.printf("%nFinal value (PESSIMISTIC): %d  (expected 30000, lost %d updates)%n",
